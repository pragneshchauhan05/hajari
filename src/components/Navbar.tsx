    ...
    <header className="sticky top-0 z-40 w-full border-b border-teal-100 bg-white/95 backdrop-blur-md shadow-sm transition-colors duration-200 dark:border-slate-800 dark:bg-slate-900/95">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-teal-500 to-emerald-400 text-white shadow-md shadow-teal-100 transition-transform hover:scale-105 dark:shadow-none">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="flex items-center space-x-1">
            ...
            <select
              ...
              className="rounded-lg border border-teal-100 bg-teal-50/50 px-2 py-1.5 text-sm font-medium text-teal-950 shadow-sm outline-none transition-colors focus:border-teal-400 focus:bg-white focus:ring-2 focus:ring-teal-100 sm:px-3 dark:border-slate-700 dark:bg-slate-800 dark:text-teal-100 dark:focus:border-teal-500"
            >
          ...
          <div className="flex items-center rounded-xl border border-teal-100 bg-teal-50/40 p-1 dark:border-slate-800 dark:bg-slate-900 select-none">
            {/* Light Mode Segment Button */}
            <button
              id="theme-light-btn"
              onClick={() => { if (isDarkMode) onToggleDarkMode(); }}
              className={`flex items-center gap-1.5 px-2 px-1.5 sm:px-3.5 sm:py-2 text-xs font-bold rounded-lg transition-all ${
                !isDarkMode
            ...
            >
              <i className="fa-solid fa-sun text-sm text-yellow-500 dark:text-amber-400"></i>
            ...
            >
              <i className="fa-solid fa-moon text-sm text-indigo-500 dark:text-indigo-400"></i>
